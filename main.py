...
def gaussian():
  image = cv2.imread("originals/ifb1.jpeg")
...
def Roberts():
  image = cv2.imread("originals/ifb2.jpeg")
  image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
def Sobel():
  image = cv2.imread("originals/brasilia1.jpeg")
  image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
def Prewitt():
  image = cv2.imread("originals/brasilia2.jpeg")
  image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
...
def Scharr():
  image = cv2.imread("originals/brasilia3.jpeg")
  image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
